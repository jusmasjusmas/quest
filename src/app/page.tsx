      ...
      <AnimatePresence>
        {whimState === "completed" ? (
          <motion.div
            key="saved-toast"
            role="status"
            className="pointer-events-none fixed bottom-28 left-1/2 z-[60] -translate-x-1/2 rounded-full bg-[#1A1A1A] px-6 py-3 font-sans text-sm font-medium text-white shadow-lg"
